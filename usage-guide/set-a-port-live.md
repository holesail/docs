...
| --key    | Connect to a server using its key            | Optional. Automatically generated by default, the length should be greater than 32 chars but can not be exactly 64 chars. |
...
```
holesail --live 3000 --host 192.168.1.1 --key "my-custom-key-string-that-I-will-not-share"
```
